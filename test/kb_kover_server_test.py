...
from kb_kover.kb_koverImpl import kb_kover
from kb_kover.kb_koverServer import MethodContext
from kb_kover.authclient import KBaseAuth as _KBaseAuth

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class kb_koverTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('kb_kover'):
        ...
        cls.serviceImpl = kb_kover(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_kb_kover_" + str(suffix)
