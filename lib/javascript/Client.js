...
function kb_kover(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.amr_prediction = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_kover.amr_prediction",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_kover.status",
